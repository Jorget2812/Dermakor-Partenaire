-- ==========================================
-- STRICT PRODUCT IMPORT - USER ONLY LIST
-- ==========================================
...
DECLARE 
    cat_id UUID;
BEGIN
    -- 1. LIMPIEZA TOTAL PARA ASEGURAR DATOS REALES
    TRUNCATE TABLE public.products;

    -- 2. INSERTAR PRODUCTOS DEL LISTADO DE JORGE (ESTRICTO)
    ...
    ('DK-MC-014', 'Pimple Patches', 'Masque Concentré', cat_id, 15.00, 20, 'IN_STOCK', 'ACTIVE'),
    ('DK-MC-015', 'Blackhead Strips', 'Masque Concentré', cat_id, 12.00, 18, 'IN_STOCK', 'ACTIVE'),
    ('DK-MC-016', 'Nose Patches', 'Masque Concentré', cat_id, 12.00, 15, 'IN_STOCK', 'ACTIVE'),
    ('DK-MC-017', 'Chin Patches', 'Masque Concentré', cat_id, 10.00, 14, 'IN_STOCK', 'ACTIVE'),
    ('DK-MC-018', 'Forehead Patches', 'Masque Concentré', cat_id, 10.00, 13, 'IN_STOCK', 'ACTIVE');
    ...
    ('DK-HC-012', 'Post-Procedure Cream', 'Gamme HomeCare', cat_id, 35.00, 5, 'IN_STOCK', 'ACTIVE');
    ...
    ('DK-AC-025', 'Foundation Cushion', 'Accessoire', cat_id, 45.00, 8, 'IN_STOCK', 'ACTIVE');
